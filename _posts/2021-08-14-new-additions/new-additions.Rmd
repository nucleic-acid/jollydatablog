...
description: |
  Over the last weeks and months I have collected three features for the blog itself that I want to implement. None are built into the {distill} package, so there's some manual work needed. I'll go through the changes here.
author:
